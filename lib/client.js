...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    function apply(ctx) {
      ...
      // turnTail is a chain slot: it requires `select`, which picks the owner
      // whose tail renders. Return the owner unconditionally so the badge shows
      // after every completed turn (no live count — bundle packages have no
      // host→client RPC).
